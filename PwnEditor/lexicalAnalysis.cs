...
public class lexer
{
    public static class lexicalHelper
    {
        ...
        /*Returns whether s is a SA:MP Callback (SA:MP specific)*/
        public static bool isCallback(string s)
        {
            if (s == "OnDialogResponse")
                return true;
            else if (s == "OnEnterExitModShop")
                return true;
            else if (s == "OnFilterScriptExit")
                return true;
            else if (s == "OnFilterScriptInit")
                return true;
            else if (s == "OnGameModeExit")
                return true;
            else if (s == "OnGameModeInit")
                return true;
            else if (s == "OnObjectMoved")
                return true;
            else if (s == "OnPlayerClickMap")
                return true;
            else if (s == "OnPlayerClickPlayer")
                return true;
            else if (s == "OnPlayerClickPlayerTextDraw")
                return true;
            else if (s == "OnPlayerClickTextDraw")
                return true;
            else if (s == "OnPlayerCommandText")
                return true;
            else if (s == "OnPlayerConnect")
                return true;
            else if (s == "OnPlayerDeath")
                return true;
            else if (s == "OnPlayerDisconnect")
                return true;
            else if (s == "OnPlayerEditAttachedObject")
                return true;
            else if (s == "OnPlayerEditObject")
                return true;
            else if (s == "OnPlayerEnterCheckpoint")
                return true;
            else if (s == "OnPlayerEnterRaceCheckpoint")
                return true;
            else if (s == "OnPlayerEnterVehicle")
                return true;
            else if (s == "OnPlayerExitVehicle")
                return true;
            else if (s == "OnPlayerExitedMenu")
                return true;
            else if (s == "OnPlayerGiveDamage")
                return true;
            else if (s == "OnPlayerInteriorChange")
                return true;
            else if (s == "OnPlayerKeyStateChange")
                return true;
            else if (s == "OnPlayerLeaveCheckpoint")
                return true;
            else if (s == "OnPlayerLeaveRaceCheckpoint")
                return true;
            else if (s == "OnPlayerObjectMoved")
                return true;
            else if (s == "OnPlayerPickUpPickup")
                return true;
            else if (s == "OnPlayerPrivmsg")
                return true;
            else if (s == "OnPlayerRequestClass")
                return true;
            else if (s == "OnPlayerRequestSpawn")
                return true;
            else if (s == "OnPlayerSelectObject")
                return true;
            else if (s == "OnPlayerSelectedMenuRow")
                return true;
            else if (s == "OnPlayerSpawn")
                return true;
            else if (s == "OnPlayerStateChange")
                return true;
            else if (s == "OnPlayerStreamIn")
                return true;
            else if (s == "OnPlayerStreamOut")
                return true;
            else if (s == "OnPlayerTakeDamage")
                return true;
            else if (s == "OnPlayerTeamPrivmsg")
                return true;
            else if (s == "OnPlayerText")
                return true;
            else if (s == "OnPlayerUpdate")
                return true;
            else if (s == "OnRconCommand")
                return true;
            else if (s == "OnRconLoginAttempt")
                return true;
            else if (s == "OnUnoccupiedVehicleUpdate")
                return true;
            else if (s == "OnVehicleDamageStatusUpdate")
                return true;
            else if (s == "OnVehicleDeath")
                return true;
            else if (s == "OnVehicleMod")
                return true;
            else if (s == "OnVehiclePaintjob")
                return true;
            else if (s == "OnVehicleRespray")
                return true;
            else if (s == "OnVehicleSpawn")
                return true;
            else if (s == "OnVehicleStreamOut")
                return true;
            else if (s == "OnVehicleStreamIn")
                return true;
            return false;
        }
    };
